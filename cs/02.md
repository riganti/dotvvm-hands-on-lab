...
> Vezměte složku `sample\DotvvmBlog.DAL` ze [vzorového projektu](https://github.com/riganti/dotvvm-hands-on-lab) a nakopírujte ji přes složku s projektem `DotvvmBlog.DAL` (přepište soubory nového projektu, který Visual Studio vytvořilo). 
