...
> Nakopírujte do tohoto projektu následující soubory a složky ze [vzorového projektu](httpos://github.com/rigatni/dotvvm-hands-on-lab), který najdete ve složce `sample\DotvvmBlog.DAL`:
> * `Migrations`
> * `Model`
> * `BlogDbContext.cs`
